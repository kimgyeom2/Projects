...
import com.mrhi2023.ex87retrofitmarketapp.databinding.RecyclerItemBinding;
...
public class MarketAdapter extends RecyclerView.Adapter<MarketAdapter.VH>{
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        String address="";
        if(item.image!=null) address= "http://mrhi2023.dothome.co.kr/RetrofitMarket/" + item.image;
