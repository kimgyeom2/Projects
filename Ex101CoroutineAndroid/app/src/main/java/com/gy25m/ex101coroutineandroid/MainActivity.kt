package com.gy25m.ex101coroutineandroid
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 안드로이드는 액티비티 or 프래그먼트의 라이프사이클이 존재함 이에 함께 반응하는 코루틴이 존재함
    ...
    private fun clickBtn2(){
        ...
        // this. 생략..[onCreate()~onDestroy()] 까지의 액티비티 라이프사이클 Owner
    ...
    private fun clickBtn3(){
        // onResume~onPause 동안에만 코루틴동작 onpause되면 자동정지
        // onResume되면 자동으로 이어서 실행
