...
import com.mrhi2023.ex82httprequest.databinding.ActivityMainBinding;
    ...
    void clickGet(){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                //GET방식으로 보낼 서버의 주소
                String serverAddress="http://mrhi2023.dothome.co.kr/Android/getTest.php";

                //GET방식은 보낼데이터(name, message)를 URL주소 뒤에 붙여서 보내는 방식
                //단, URL에는 한글 및 특수문자 사용 불가 - 한글을 URL에 사용될 수 있도록 암호화(인코딩)
                try {
                ...
                try {
                    ...
                    //url.openStream(); URL은 InputStream 만 열수 있음.
                    ...
                    //서버로 부터 응답(Response)된 결과를 받아보기 위해..
    ...
    void clickPost(){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                String serverAddress="http://mrhi2023.dothome.co.kr/Android/postTest.php";
                ...
                try {
                    ...
                    //보낼 데이터들 POST방식으로 쓰기 위해 [key=value]규칙에 맞게 하나의 문자열로 결합
