package com.gy25m.ex66locationfusedapi;
...
public class MainActivity extends AppCompatActivity {
    ...
    void clickBtn() {
        //위치정보는 동적 퍼미션 필수
        int permissionResult = checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION); //코어스도 같이받아줌
        ...
        locationRequest.setInterval(5000); //갱신주기
    ...
    //액티비티가 화면에서 안보이기 시작할때 자동으로 발동하는 콜백 메소드
    @Override
