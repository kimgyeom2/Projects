...
public class Tab3Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //대량의 데이터 추가
        items.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        ...
        items2.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items2.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items2.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items2.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items2.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        ...
        items3.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items3.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items3.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items3.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
        items3.add(new Tab3RecyclerItem("하울",R.drawable.howl049));
