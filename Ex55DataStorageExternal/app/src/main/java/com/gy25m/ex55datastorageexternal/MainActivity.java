package com.gy25m.ex55datastorageexternal;
...
public class MainActivity extends AppCompatActivity {
    ...
    void clickSave(){
        ...
        //외부 메모리의 상태가 연결(mounted)되어 있지 않은가를 확인
        if(!state.equals(Environment.MEDIA_MOUNTED)){  //!붙이면 뒷내용 '빼고 다'
            Snackbar.make(tv,"SD card is not mount",Snackbar.LENGTH_LONG).show();
            return; //함수 멈추기
        }
