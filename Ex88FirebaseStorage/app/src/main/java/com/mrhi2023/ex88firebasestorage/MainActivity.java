package com.mrhi2023.ex88firebasestorage;
...
import com.mrhi2023.ex88firebasestorage.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    // 파이어 베이스 사이트에 로그인하고 console에서 [프로젝트 만들기 ] 를 통해 작업시작
    ...
    void clickLoad(){
        ...
        if(imgRef!=null){
            //파일 참조객체로 부터 이미지의 [다운로드 URL]를 얻어오기
