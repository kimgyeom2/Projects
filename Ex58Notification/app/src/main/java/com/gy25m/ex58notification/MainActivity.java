package com.gy25m.ex58notification;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn).setOnClickListener(view->{
            ...
            // Android 13버전(api 33) 부터 알림에 대한 동적 퍼미션이 추가됨
            ...
            // 빌더를 생성하는 문법이 26버전(Oreo버전)부터 변경되었음.
            // 알림채널 이라는 개념이 도입되었음.
            // 그래서 26버전 이상의 폰에서는 알림채널객체를 생성해야 하고
            // 그 이전버전에서는 알림채널객체 생성없이 빌더를 만들어야 함.
            ...
            Bitmap bm= BitmapFactory.decodeResource(res, R.drawable.howl049);
            builder.setLargeIcon(bm);

            // 알림창을 클릭했을때 새로운 화면(SecondActivity)가 실행되도록..
            Intent intent= new Intent(this, SecondActivity.class);
            //인텐트객체에게 바로 실행하지 말고 잠시 보류해 달라고..
            ...
            // 요즘들어 보이는 알림창 스타일 꾸미기..
            NotificationCompat.BigPictureStyle style= new NotificationCompat.BigPictureStyle();
            style.bigPicture(BitmapFactory.decodeResource(res, R.drawable.howl049));
            builder.setStyle(style);

            // 다른 스타일의 종류도 많음..개발자 사이트를 통해 추후 확인

            // 알림창의 클릭 액션에 의해 실행될 화면에 여러개 일때..사용하는 기능
            builder.addAction(R.drawable.ic_notification, "setting", pendingIntent);
            builder.addAction(R.drawable.ic_notification, "information", pendingIntent);
